...
class DataFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'survey_date' => ['type' => 'integer', 'length' => 8, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => 'YYYYMMDD (zeroes for undefined month/day, YYYYQ200 for second quarter)', 'precision' => null, 'autoIncrement' => null],
